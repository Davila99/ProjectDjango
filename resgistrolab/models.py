...
class Curso(models.Model):
    ...
    def __str__(self):
        return self.nom_practica, ano, semestre
...
class PrestamoLaboratorio(models.Model):
    ...
    def __str__(self):
        return self.curso, usuario, laboratorio, fecha, cantidad_horas


class DetallePrestamo(models.Model):
    prestamo_id = models.ForeignKey(
    ...
    def __str__(self):
        return self.prestamo_id, sexo_id, cantidad
